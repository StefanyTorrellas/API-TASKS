...
router.post(
  ...
  [
    validarToken,
    check("nombreTarea", "El nombre de la tarea es obligatorio")
      .not()
      .isEmpty(),
    check("descripcion", "La descripcion de la tarea es obligatorio")
      .not()
      .isEmpty(),
...
router.put(
  ...
  [
    ...
    check("nombreTarea", "El nombre de la tarea es obligatorio")
      .not()
      .isEmpty(),
    check("descripcion", "La descripcion de la tarea es obligatoria")
      .not()
      .isEmpty(),
    check("usuarioId", "usuarioId es obligatorio").custom(existeUsuarioPorId),
